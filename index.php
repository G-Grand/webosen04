        ...
        $(function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    var lis = "", div2, link, text;
                    var group = document.createDocumentFragment();
                    for (var i = 0; i < data.length; ++i) {
                        div2 = document.createElement("DIV");
                        div2.style.backgroundImage = "url('/gallery/" + data[i].image + "')";
                        link = document.createElement("A");
                        link.setAttribute("href", "#");
                        text = data[i].order_status + " " +
                            data[i].property_Type + ", " +
                            data[i].city + "  " +
                            data[i].district + "<br/>" +
                            data[i].floor + "-эт. " + data[i].general + "кв.м. " + data[i].price + "грн.";
                        link.innerHTML = text;
...
<div class="content">
    ...
    <div class="centr">
                        ...
                        <div class="block_search">
                            <div class="block_search_body">
                                ...
                                <form name="form" action="vuvod.php" method="GET">
                                    ...
                                    <table>
                                        <tr>
                                            <td><p class="vvod_p">Количество комнат </p></td>
                                            <td><input class="vvod" placeholder="От" value="" name="min_rooms"> <input
                                                    class="vvod" placeholder="До" value="" name="max_rooms"></td>
                                        </tr>
                                        <tr>
                                            <td><p class="vvod_p">Этаж</td>
                                            </p>
                                            <td><input class="vvod" placeholder="От" value="" name="min_ floor"> <input
                                                    class="vvod" placeholder="До" value="" name="max_ floor">
                                            <td>
                                        </tr>
                                        <tr>
                                            <td><p class="vvod_p">Общая площадь, кв.м </p></td>
                                            <td><input class="vvod" placeholder="От" value="" name="min_general"> <input
                                                    class="vvod" placeholder="До" value="" name="max_general"></td>
                                        </tr>
                                        <tr>
                                            <td><p class="vvod_p">Цена, грн </p></td>
                                            <td><input class="vvod" placeholder="От" value="" name="min_price"> <input
                                                    class="vvod" placeholder="До" value="" name="max_price"></td>
                                        </tr>
                                    </table>
                                    </ul>
                                ...
                                <ul class="spisok_index">
                                    <table>
                                        <li>
                                            <tr>
                                                <td><p class="vvod_p">Количество комнат </p></td>
                                                <td><input class="vvod" placeholder="От" value="" name="min_rooms">
                                                    <input class="vvod" placeholder="До" value="" name="max_rooms"></td>
                                            </tr>
                                        </li>
                                        <li>
                                            <tr>
                                                <td><p class="vvod_p">Общая площадь, кв.м </p></td>
                                                <td><input class="vvod" placeholder="От" value="" name="min_general">
                                                    <input class="vvod" placeholder="До" value="" name="max_general">
                                                </td>
                                            </tr>
                                        </li>
                                        <li>
                                            <tr>
                                                <td><p class="vvod_p">Цена, грн </p></td>
                                                <td><input class="vvod" placeholder="От" value="" name="min_price">
                                                    <input class="vvod" placeholder="До" value="" name="max_price"></td>
                                            </tr>
                                        </li>
                                    </table>
                                </ul>
        ...
        <div class="fresh">
            <div class="new_fresh"><h3>Новые обьявления на сайте</h3>
                <hr/>
            </div>
        ...
        <div class="fresh">
            <div class="new_fresh"><h3>Новости</h3>
                <hr/>
            </div>
